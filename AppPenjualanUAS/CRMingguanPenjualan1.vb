...
Public Class CRMingguanPenjualan1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRMingguanPenjualan1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AppPenjualanUAS.CRMingguanPenjualan1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRMingguanPenjualan1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRMingguanPenjualan1 = New CRMingguanPenjualan1()
        rpt.Site = Me.Site
        Return rpt
    End Function
