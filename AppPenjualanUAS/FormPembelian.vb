...
Public Class FormPembelian
    ...
    Private Sub tbNM_Supplier_TextChanged(sender As Object, e As EventArgs) Handles tbNM_Supplier.TextChanged
        Call Koneksi()
        CMD = New SqlCommand("select id_supplier from master_supplier where nama_supplier='" & tbNM_Supplier.Text() & "'", Conn)
        reader = CMD.ExecuteReader
        If reader.Read Then
            tbID_Supplier.Text() = reader(0)
        End If
    End Sub
    ...
    Private Sub lbBarang_SelectedIndexChanged(sender As Object, e As EventArgs) Handles lbBarang.SelectedIndexChanged
        ...
        Call Koneksi()
        CMD = New SqlCommand("select Kode_Barang, Nama_Barang, Harga_Beli from Master_Barang where Kode_Barang='" & DGV.Rows(baris).Cells(0).Value & "'", Conn)
        reader = CMD.ExecuteReader
        reader.Read()
        If reader.HasRows Then
            DGV.Rows(baris).Cells(1).Value = reader.Item("Nama_Barang")
            DGV.Rows(baris).Cells(2).Value = reader.Item("Harga_Beli")
    ...
    Private Sub btSimpan_Click(sender As Object, e As EventArgs) Handles btSimpan.Click
        ...
        Using connection As New SqlConnection(connectionString)
            ...
            Dim cmdText As String = "INSERT INTO Pembelian (No_Transaksi, Tanggal, Nama_Supplier, Kode_Barang, Nama_Barang, Harga_Beli, Jumlah_Barang, Total_Harga) VALUES (@No_Transaksi, @Tanggal, @Nama_Supplier, @Kode_barang, @Nama_Barang, @Harga_Beli, @Jumlah_Barang, @Total_Harga)"
            ...
            command.Parameters.Add(New SqlParameter("@Nama_Supplier", SqlDbType.VarChar))
            ...
            command.Parameters.Add(New SqlParameter("@Harga_Beli", SqlDbType.Int))
            ...
            Try
                ...
                For i As Integer = 0 To DGV.Rows.Count - 2
                    ...
                    command.Parameters("@Nama_Supplier").Value = tbNM_Supplier.Text
                    ...
                    command.Parameters("@Harga_Beli").Value = DGV.Rows(i).Cells(2).FormattedValue
