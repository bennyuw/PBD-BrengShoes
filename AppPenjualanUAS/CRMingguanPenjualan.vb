...
Public Class CRMingguanPenjualan
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRMingguanPenjualan.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AppPenjualanUAS.CRMingguanPenjualan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRMingguanPenjualan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRMingguanPenjualan = New CRMingguanPenjualan()
        rpt.Site = Me.Site
        Return rpt
    End Function
