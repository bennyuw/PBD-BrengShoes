...
Public Class LaporanMingguanPenjualan

    Private Sub LaporanMingguanPenjualan_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub BtnOk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
        ...
        Try
            ...
            Else
                ...
                BulananPenjualan.CrystalReportViewer1.SelectionFormula = "Month({Penjualan.Tanggal}) =" & Val(int_bulan) & " and Year({Penjualan.Tanggal}) =" & Val(cbTahun.Text)

                BulananPenjualan.CrystalReportViewer1.RefreshReport()

                BulananPenjualan.WindowState = FormWindowState.Maximized

                BulananPenjualan.Show()
